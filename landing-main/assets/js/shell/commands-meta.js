...
export function makeMetaCommands(S) {
  ...
  return {
    help: function () {
      ...
      rows([
        ['nano <файл>', 'создать / редактировать файл (^O сохр · ^U ссылка · ^X выход)'],
        ['nano --share <ф>', 'выложить файл ссылкой на teamleads.kz/p/…'],
      ...
      rows([
        ...
        ['agents', 'рецепты агентов: промпты, скиллы, харнессы'],
