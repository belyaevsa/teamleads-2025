...
export function makeMan() {
  var MANPAGES = {
    ...
    team: 'team – тимагочи «Тимлид»: вырасти разработчика и команду в консоли. Анимированный напарник в HUD-полосе реагирует на метрики (доверие, экспертиза, настрой, конфликт). team new [coder|frontender|teamlead] – начать, team – дашборд, team reset – сбросить, team help – правила. Состояние хранится в браузере и проседает со временем без ухода. Синонимы: tamagotchi, тимагочи, pet.',
    '1on1': '1on1 [имя] – провести one-on-one: +доверие, -конфликт, +настрой. Базовое действие тимагочи.',
    mentor: 'mentor [имя] – менторить разработчика: +экспертиза и +опыт ценой части настроя. Действие тимагочи.',
    cr: 'cr – код-ревью команды: +экспертиза и немного доверия, но придирки слегка злят. Синоним: codereview. Действие тимагочи.',
    pair: 'pair – парное программирование: +экспертиза и +настрой. Действие тимагочи.',
    delegate: 'delegate [задача] – делегировать: +настрой и +доверие (команда чувствует доверие), небольшой риск. Действие тимагочи.',
    retro: 'retro – ретроспектива: сильно снижает конфликт, поднимает доверие. Действие тимагочи.',
    hire: 'hire – нанять человека в команду (со случайным трейтом). Онбординг временно проседает метрики. Действие тимагочи.',
    fire: 'fire <имя> – уволить человека из команды. Токсичных терять не жалко, своих – больно. Действие тимагочи.',
    ship: 'ship – выкатить релиз: конвертирует экспертизу/настрой/низкий конфликт в релизы (цель победы) ценой настроя. При выгорании люди уходят. Действие тимагочи.',
    standup: 'standup – прожить день: синк команды, дрейф метрик и шанс события. Синоним: daily. Действие тимагочи.',
